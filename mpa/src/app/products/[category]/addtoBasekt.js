        ...
        <div className="group-hover:block hover:bg-green-600 hover:fill-white
            ...
            <div className="w-5 h-5">
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25
                    38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5
                    ...
                    464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"/>
                </svg>
            </div>
        </div>
    )
